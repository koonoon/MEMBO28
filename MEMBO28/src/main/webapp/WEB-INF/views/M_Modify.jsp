                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <h2>${modi.mId}</h2>
                                    <input class="input--style-4" type="hidden" name="mId" value="${modi.mId}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4" type="date" name="mBirth">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="p-t-10">
                                        <label class="radio-container m-r-45">Male
                                            <input type="radio" checked="checked" name="mGender" value="남">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="email" name="mEmail">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Phone Number</label>
                                    <input class="input--style-4" type="text" name="mPhone">
                                </div>
                            </div>
                        </div>
                       <div class="input-group">
                                    <label class="label">Profile</label>
                                    <input class="input--style-4" type="file" name="mProfile">
                                </div>  
                        <div class="p-t-15">
